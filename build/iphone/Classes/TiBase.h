...
// in simulator we redefine to format for Scaffold Developer console
...
{\
	NSString * exceptionName = [@"org.scaffold." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.scaffold";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIScaffoldNativeItemNone = -1, 
	UIScaffoldNativeItemSpinner = -2,
	UIScaffoldNativeItemProgressBar = -3,
	
	UIScaffoldNativeItemSlider = -4,
	UIScaffoldNativeItemSwitch = -5,
	UIScaffoldNativeItemMultiButton = -6,
	UIScaffoldNativeItemSegmented = -7,
	
	UIScaffoldNativeItemTextView = -8,
	UIScaffoldNativeItemTextField = -9,
	UIScaffoldNativeItemSearchBar = -10,
	
	UIScaffoldNativeItemPicker = -11,
	UIScaffoldNativeItemDatePicker = -12,
	
	UIScaffoldNativeItemInfoLight = -13,
	UIScaffoldNativeItemInfoDark = -14,
	
	UIScaffoldNativeItemDisclosure = -15,
	
	UIScaffoldNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Scaffold instances of
