 ...
 * Copyright (c) 2009-2011 by Scaffold, Inc. All Rights Reserved.
...
@interface ScaffoldObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ScaffoldObject class]])
		{
			for (NSString *key in [[(ScaffoldObject*)o modules] allKeys])
			{
