...
/**
 The base class for all Scaffold modules
 */
...
/**
 Scaffold Platform calls this method on startup.
 */
-(void)startup;

/**
 Scaffold Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Scaffold Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Scaffold Platform calls this method on resume.
 @param sender The sender of the event.
 */
